    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <form class="form-inline my-2 my-lg-0 search pl-3">
        ...
        <?php $__env->startComponent('components.navbars.itemnav'); ?>
            <div class="users">
                <div id='nav-avatar' class="img-circle">
                    <img src="/storage/images/users/<?php echo e(Auth::user()->avatar); ?>" alt="">
                </div>
                <div class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu profile" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li> <a class="dropdown-item" href="/project/create"><i class="fa fa-plus-circle"></i> Project</a></li>
                        
                        <li> <a class="dropdown-item" href="/about"><i class="fa fa-life-ring"></i> about</a></li>
                        <li>
                            <a class="dropdown-item" href="/logout"><i class="fa fa-sign-out"></i> Log Out</span></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    </nav><?php /**PATH /mnt/d/laravel/project/CollProjectMS/resources/views/components/navbars/login.blade.php ENDPATH**/ ?>